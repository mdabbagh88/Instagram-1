//
//  UIImage+UIImage_BLCImageUtilities.m
//  Blocstagram
//
...
@implementation UIImage (UIImage_BLCImageUtilities)
...
- ( UIImage * ) imageByScalingToSize:(CGSize)size andCroppingWithRect:( CGRect )rect
{
  ...
  img = [UIImage imageWithCGImage:newImageRef scale:self.scale orientation:UIImageOrientationUp];
  ...
  img = [UIImage imageWithCGImage:imageRef scale:self.scale orientation:self.imageOrientation];
